...
public class tenaga extends TabActivity implements OnClickListener{
	
		
		ImageView animationview;
		Button btstart,btstop;
		AnimationDrawable usaha;
		WebView webview1,webview2,webview3;
		
		@Override
		protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView (R.layout.tenaga);
			...
			animationview = (ImageView)findViewById(R.id.AnimatedIviewt);
			...
			animationview.setBackgroundResource(R.drawable.usaha);
			
			usaha = (AnimationDrawable) animationview.getBackground();
			...
			String content1 = ambilResource(getResources(), R.raw.tng1);
			...
			webview2 = (WebView) findViewById(R.id.tng2);
			webview2.setBackgroundColor(0);
			webview2.setBackgroundColor(Color.TRANSPARENT);
			webview2.getSettings().setBuiltInZoomControls(true);
			webview2.getSettings().setSupportZoom(true);
			String content2 = ambilResource(getResources(), R.raw.tng2);
			...
			webview3 = (WebView) findViewById(R.id.tng3);
			webview3.setBackgroundColor(0);
			webview3.setBackgroundColor(Color.TRANSPARENT);
			webview3.getSettings().setBuiltInZoomControls(true);
			webview3.getSettings().setSupportZoom(true);
			String content3 = ambilResource(getResources(), R.raw.tng3);
